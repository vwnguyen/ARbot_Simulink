...
function [P_B  distanceToCatchLine timeToCatchLine ikSol P_C] = mapToCatchArc(P_B_CORG,P_C,belt_rate,rotation_matrix,max_Catching_Time,eeOrientation,dist_To_Catch,catching_arc,ikSols)
    ...
    for i=1:target_Size(1)
        ...
        [minValue,closestIndex,closestValue] = findClosest(P_C(i,2),P_W);
        ...
        P_C(i,2) = P_W(closeIndexFinal,2);
        P_C(i,1) = P_W(closeIndexFinal,1);
        P_C(i,3) = P_W(closeIndexFinal,3);
