...
box1_pos_offset = [(box1_dim(1)/2 + box_positions(1,1) ) (box1_dim(2)/2 + (belt_w - 0.761613922548294) ) box_z_offset ]; %time 0
box2_pos_offset = [(box2_dim(1)/2 + box_positions(2,1) ) (box2_dim(2)/2 + (belt_w - 1.07917752695084 + 0.4226) - (belt_spd*(2.66666666666664)) ) box_z_offset ]; % time 2.667
box3_pos_offset = [(box3_dim(1)/2 + box_positions(3,1) ) (box3_dim(2)/2 + (belt_w - 0.982776597929001 + 0.4572) - (belt_spd*(7.66666666666666)) ) box_z_offset ]; % time 7.667
box4_pos_offset = [(box4_dim(1)/2 + box_positions(4,1) ) (box4_dim(2)/2 + (belt_w - 1.02983778786659 + 0.4353) - (belt_spd*(10.7333333333335))) box_z_offset ]; % time 10.733
box5_pos_offset = [(box5_dim(1)/2 + box_positions(5,1) ) (box5_dim(2)/2 + (belt_w - 0.107290405601263 + 0.4270) - (belt_spd*(16.2000000000004)) ) box_z_offset ]; % time 16.200
